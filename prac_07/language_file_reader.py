...
# Imports the class ProgrammingLanguage from programming_language.py
from prac_07.programming_language import ProgrammingLanguage


# from programming_language import Program
...
def main():
    ...
    for line in in_file:
        ...
        # Gives point arithmetic as Boolean instead of a Yes/No string
        pointer_arithmetic = parts[4] == "Yes"
        # print(pointer_arithmetic) # for debugging
    ...
    for language in languages:
        ...
        print(f"{language.name} {status} capable of pointer arithmetic")
        print(language)


print("\nUsing Class")  # for debugging
main()
...
# print("\nUsing Named Tuple")  # for debugging
# using_namedtuple()
...
# print("\nUsing CSV Named Tuple")  # for debugging
